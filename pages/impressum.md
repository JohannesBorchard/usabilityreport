...
<td itemprop="email">contact@johannesborchard.de</td>
...
<br>
</p><h3 id="dsg-general-controller">Verantwortlicher</h3><p><span class="tsmcontroller">Johannes Borchard <br>
Elsa-Brandström-Straße 6 <br>
97218 Gerbrunn <br>
0162 4995243 <br>
contact@johannesborchard.de</span></p><h3 id="dsg-general-datatype">Arten der verarbeiteten Daten:</h3><p>-	Bestandsdaten (z.B., Namen, Adressen).<br>
...
<br>
Die personenbezogenen Daten der Nutzer werden nach 14 Monaten gelöscht oder anonymisiert.</span></p><a href="https://datenschutz-generator.de" class="dsg1-5" rel="nofollow" target="_blank">
